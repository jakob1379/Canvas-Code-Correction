...
- I created this file at docs/architecture.md. If you'd like, I can also:
  - Add a docs/README.md with quickstart steps and a sample config.ini template.
  - Export the mermaid diagrams as PNG/SVG and save them under docs/.
  - Create a sample assignment/code/main.sh template that writes the required files for demonstration.
