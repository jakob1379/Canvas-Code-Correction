...
Welcome to the Canvas Code Correction (CCC) tutorial for **course responsible
and course administrators**. This guide focuses on creating **work
packages**—self-contained units that define how student assignments are
...
Once you create a work package, the CCC platform operators can deploy it to
...
Deploying and operating the CCC platform is handled by **platform operators**.
After you create your work package, they will:
